...
% Stijn Wellens
% March, 2016
function[] = syncKinectImages( folder_nmb, begin_directory )
% clear

begin_directory = str2num(strtrim(begin_directory));
folder_nmb =  str2num(strtrim(folder_nmb));
...
% datasetDir = '.';
datasetDir = sprintf('/esat/wasat/r0300219/NYUv2/raw%d', folder_nmb)
% datasetDir = 'data/NYU';
...
% sizeD = 2;
    ...
    if exist(sprintf('/esat/wasat/r0300219/NYUv2/processed/syncKinect_%d.mat',folder_nmb),'file')
        directory = load(sprintf('/esat/wasat/r0300219/NYUv2/processed/syncKinect_%d.mat',folder_nmb));
...
for k = begin_directory:1:sizeD
    % Save the directory where the method is working on (for Condor usage)
      save(sprintf('/esat/wasat/r0300219/NYUv2/processed/syncKinect_%d.mat',folder_nmb), 'k');
...
%     sceneDir = sprintf('%s/%s', datasetDir, sceneName, afterName);
    ...
    % depthmaps
    save_dir_prefix = sprintf('/esat/wasat/r0300219/NYUv2/processed/imgs_%d',folder_nmb);
    image_filenames = dir(sprintf('/esat/wasat/r0300219/NYUv2/processed/imgs_%d/',folder_nmb));
...
%     if exist(sprintf('/esat/wasat/r0300219/NYUv2/processed/labels_filled/labels_%d.mat',folder_nmb),'file')
%     labels_previous = load(sprintf('/esat/wasat/r0300219/NYUv2/processed/labels_filled/labels_%d.mat',folder_nmb));
...
%     save(sprintf('/esat/wasat/r0300219/NYUv2/processed/labels_filled/labels_%d.mat',folder_nmb), 'labels_processed', 'labels_name');
%     else
%         labels = struct('labels',labels_processed,'name',labels_name);
        save(sprintf('/esat/wasat/r0300219/NYUv2/processed/labels_filled/labels_%d_%d.mat',folder_nmb, nmbImagesAlreadyProcessed+im_nmb), 'labels_processed', 'labels_name');
%         save('data/processed/labels/labels.mat', 'labels');
%     end
