...
%% Data new
% nyudepth_labels_fullset = load('/esat/wasat/r0300219/NYUv2/processed/labels/labels.mat');
% % nyudepth_labels2 = load('/esat/wasat/r0300219/NYUv2/processed/labels/labels2.mat');
% 
% nyudepth_augmented_labels = nyudepth_labels_fullset.labels_processed;
% % nyudepth_labels2 = nyudepth_labels2.labels;
% 
% % nyudepth_labels = cat(3, nyudepth_labels, nyudepth_labels2);
% 
% image_filenames = dir('/esat/wasat/r0300219/NYUv2/processed/images/');
% all_filenames={};
% filename_idx = 1;
% for i=1:numel(image_filenames)
%     filename_this = image_filenames(i);
%     if filename_this.bytes ~= 0
%         all_filenames{filename_idx} = strcat('/esat/wasat/r0300219/NYUv2/processed/images/',filename_this.name);
%         filename_idx = filename_idx + 1;
%     end
% end
...
opts.expDir = '/esat/wasat/r0300219/Thesis/new_coarse_01';
...
dataset.images.data   = all_filenames;%images_resized;
%dataset.images.labels = labels_resized;
dataset.images.labels = nyudepth_augmented_labels.labels_all;
dataset.images.set = [ones(nmb_training,1); 2*ones(nmb_images-nmb_training,1)];
...
save('/esat/wasat/r0300219/Thesis/new_coarse_01/coarsecnn.mat', '-struct', 'net') ;
