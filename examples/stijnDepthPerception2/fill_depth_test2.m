...
%     image = im2single(imread(image_filename));
    ...
    imgDepth = imresize(imgDepth, [480, 640]);
    imgRgb = imresize(imgRgb, [480, 640]);
    
%     imgIsNoise = (imgDepth <= 0.5 | imgDepth >= 10);
  ...
  denoisedDepthImg = new_vals * maxImgAbsDepth;
    ...
    labels_denoised(:,:,k) = imresize(denoisedDepthImg, [55, 74]);
...
save('/esat/wasat/r0300219/NYUv2/processed/labels/labels_01_denoised_resized.mat', 'labels_processed', 'labels_name');
