...
% addpath('/media/stijnwellens/Dataschijf/Desktop/Thesis/depth_mapping_with_CNN_git/toolbox_nyu_depth_v2');
...
% datasetDir = '/home/stijnwellens/Downloads/libfreenect-master/bin'
% datasetDir = 'data/NYU';
datasetDir = '/esat/wasat/r0300219/ESAT_dataset';
...
%% Open directory position
    if exist('/esat/wasat/r0300219/NYUv2/processed/syncKinect_esat.mat','file')
        directory = load('/esat/wasat/r0300219/NYUv2/processed/syncKinect_esat.mat');
        begin_directory = directory.k + 1;
    else
        begin_directory = 16;
    end

for k = begin_directory:1:sizeD
     % Save the directory where the method is working on (for Condor usage)
      save('/esat/wasat/r0300219/NYUv2/processed/syncKinect_esat.mat', 'k');
...
%     nmbOfImages = 20;
    ...
    % depthmaps
    save_dir_prefix ='/esat/wasat/r0300219/NYUv2/processed/images_esat_filled';
    image_filenames = dir('/esat/wasat/r0300219/NYUv2/processed/images_esat_filled/');
    
%     save_dir_prefix ='/home/stijnwellens/Documents/Thesis/Test_images';
...
%     if exist('/home/stijnwellens/Documents/Thesis/Test_images/labels/labels_esat.mat','file')
%     labels_previous = load('/home/stijnwellens/Documents/Thesis/Test_images/labels/labels_esat.mat');
%     if exist('data/processed/labels/labels.mat','file')
%     labels_previous = load('data/processed/labels/labels.mat');

%     if exist('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat_filled.mat','file')
%         labels_previous = load('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat_filled.mat');
% 
...
%         save('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat_filled.mat', 'labels_processed', 'labels_name');
%     else
...
%     end
        ...
        save(sprintf('/esat/wasat/r0300219/NYUv2/processed/labels_filled/labels_esat_%d.mat', nmbImagesAlreadyProcessed+im_nmb), 'labels_processed', 'labels_name');
