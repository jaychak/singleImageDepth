...
addpath('/users/start2013/r0300219/Documents/Thesis/depth_mapping_with_CNN/gcsparse');
...
%     sceneDir = sprintf('%s/%s', datasetDir, sceneName, afterName);
    ...
    % depthmaps
    save_dir_prefix ='/esat/wasat/r0300219/NYUv2/processed/images_esat2';
    image_filenames = dir('/esat/wasat/r0300219/NYUv2/processed/images_esat2/');
    
%     save_dir_prefix ='/esat/wasat/r0300219/NYUv2/processed/images_05';
%     image_filenames = dir('/esat/wasat/r0300219/NYUv2/processed/images_05/');
...
%         if(nmbBlackPoints < numel(imgDepthAbs)*0.4)
            ...
            imgDepthFilled = fill_depth_colorization_gpu(double(imgRgb), double(imgDepthAbs));
...
%        end
    ...
    if exist('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat2.mat','file')
    labels_previous = load('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat2.mat');
...
%     save('data/processed/labels/labels.mat', 'labels');
    save('/esat/wasat/r0300219/NYUv2/processed/labels/labels_esat2.mat', 'labels_processed', 'labels_name');
    else
