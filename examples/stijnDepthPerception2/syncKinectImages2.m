...
% datasetDir = '.';
datasetDir = '/esat/wasat/r0300219/NYUv2/raw2';
% datasetDir = 'data/NYU';
...
%     sceneDir = sprintf('%s/%s', datasetDir, sceneName, afterName);
    ...
    % depthmaps
    save_dir_prefix ='/esat/wasat/r0300219/NYUv2/processed/images_04';
    image_filenames = dir('/esat/wasat/r0300219/NYUv2/processed/images_04/');
...
%         end
    ...
    if exist('/esat/wasat/r0300219/NYUv2/processed/labels/labels_04.mat','file')
    labels_previous = load('/esat/wasat/r0300219/NYUv2/processed/labels/labels_04.mat');
...
%     save('data/processed/labels/labels.mat', 'labels');
    save('/esat/wasat/r0300219/NYUv2/processed/labels/labels_04.mat', 'labels_processed', 'labels_name');
    else
